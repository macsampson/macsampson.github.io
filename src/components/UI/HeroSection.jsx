        ...
        >
          ...
          <div>
            ...
            <p className="text-lg sm:text-l leading-relaxed opacity-90 mb-6">
              ...
              I'm actively studying ray tracing and also built Apparition.io, an end-to-end AI
              video generation pipeline using Stable Diffusion, LLaMA 3, Whisper, and FFmpeg on
              a single RTX 3090 with sequential VRAM loading.
            </p>
          </div>
          ...
          <div>
            <div className="px-3 py-2 bg-secondary/10 border border-secondary/20 rounded-md">
              ...
              <div className="flex flex-row gap-11">
                <div>
                  <div className="text-md font-bold opacity-90">
